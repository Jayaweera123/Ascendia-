            ...
            <div className="overflow-x-auto ">
              <div className="pt-3 pb-10 pl-10 pr-10 bg-white rounded-lg shadow-md">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="mb-8">
                    <button
                      className="mt-6 bg-[#101d3f] hover:bg-sky-800 text-white font-bold py-2 px-4 rounded al "
                ...
                <table className="min-w-full text-sm bg-white">
                  ...
                  <tbody className="text-blue-gray-900">
                    {records
                      ...
                      .map((material) => (
                        <tr
                          className="bg-white border-b border-blue-gray-200 dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600"
                          ...
                          <td class="w-4 p-4">
                            <div class="flex items-center">
                              <input
                                ...
                                onChange={() =>
                                  handleCheckboxChange(material.materialCode)
                                }
                              />
                              <label
