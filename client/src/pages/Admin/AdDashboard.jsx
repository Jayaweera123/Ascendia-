      ...
      <div className="relative h-screen">
        ...
        <button className="overflow-hidden rounded-3xl">
          <div className="grid grid-cols-[100px,1fr] pl-10 gap-x-0">
            ...
            <h2 className="pl-5 text-left text-3xl leading-relaxed font-bold text-[#001b5e]">Add User</h2>
            </div>
          </div>
        </button>
        <br></br>
        ...
        <button className="overflow-hidden rounded-3xl">
          <div className="grid grid-cols-[100px,1fr] pl-10 gap-x-0">
            ...
            {/* Column 2 */}
            <div className="p-4 bg-white w-[300px] opacity-80">
            <h2 className="pl-5 text-left text-3xl leading-relaxed font-bold text-[#001b5e]">Edit User</h2>
            </div>
          </div>
        </button>
      </div>
