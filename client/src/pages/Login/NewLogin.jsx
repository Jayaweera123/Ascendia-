...
const NewLogin = () => {
  ...
  return (
    <div className="h-screen overflow-hidden flex items-center justify-center" style={{ background: '#edf2f7' }}>
      <div className="bg-[#14244a] absolute top-0 left-0 bg-gradient-to-b from-gray-900 via-gray-900 to-[#101d3f] bottom-0 leading-5 h-full w-full overflow-hidden">
            ...
            <div className="space-y-6">
              ...
              <div className="relative" x-data="{ show: true }">
                <input
                  ...
                  className="text-sm text-gray-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-indigo-500"
                />
