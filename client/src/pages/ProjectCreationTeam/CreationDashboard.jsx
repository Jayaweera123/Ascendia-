            ...
            <button className="overflow-hidden rounded-3xl">
              ...
              <div className="grid grid-cols-[100px,1fr] pl-10 gap-x-0">
                ...
                <div className="p-4 bg-white w-[300px] opacity-80">
                  <h2 className="pl-5 text-left text-3xl leading-relaxed font-bold text-[#001b5e]">Create Project</h2>
                </div>
              </div>
            </button>
            <button className="overflow-hidden rounded-3xl">
              ...
              <div className="grid grid-cols-[100px,1fr] pl-10 gap-x-0">
                ...
                <div className="p-4 bg-white w-[300px] opacity-80">
                  <h2 className="pl-5 text-left text-3xl leading-relaxed font-bold text-[#001b5e]">Add Employee</h2>
                </div>
              </div>
            </button>
          </div>
