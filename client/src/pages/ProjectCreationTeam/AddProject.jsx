 ...
 return (
   <div>
    ...
    <MdAssignmentAdd size={70} color="#001b5e" />
          <div><h1 className="place-items-baseline py-1/2 text-5xl font-bold leading-relaxed text-left text-[#001b5e]">Create Project</h1></div>
        </div>
    ...
    <div className="mt-2">
          ...
          <div class="pr-4 sm:w-1/2">
           <label for="added-date" class="block text-base font-medium leading-6 text-gray-900">
             ...
             <input
              ...
              class="block w-1/2 h-10 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 tracking-wide"
              />
            </div>
         </div>
        {/*End Date*/}   
     ...
     {/* Assign buttons */}
      <div className="mt-16">
      <button onClick={handleAssignProjectManager} className="flex items-center px-4 h-10 py-2 mr-4 font-bold text-gray-300 bg-[#101d3f] rounded-md text-gray hover:bg-blue-800">
        <span className="mr-2">
          <IoPersonAdd />
          </span>
