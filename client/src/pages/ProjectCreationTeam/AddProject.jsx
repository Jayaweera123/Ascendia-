   ...
   <div>
    ...
    <MdAssignmentAdd size={90} color="#001b5e"/>
          <div><h1 className="place-items-baseline py-4 text-4xl font-bold leading-relaxed text-left text-[#001b5e]">Create Project</h1></div>
                ...
                <div className="relative m-32 overflow-x-auto bg-green-500 rounded-lg shadow-md">
 ...
 <div>
    ...
    <div className="mt-2">
        <input
            ...
            className="block w-1/2 h-10 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-900 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:Lending-6"
        />
    </div>
</div>
