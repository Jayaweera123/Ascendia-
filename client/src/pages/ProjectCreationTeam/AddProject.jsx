                          ...
                          <div className="flex flex-col mt-12 ml-24 sm:col-span-8">
                            <div className="mt-8">
                              ...
                              <div className="mt-2">
                                ...
                                {errors.projectType && (
                                  <p className="mt-2 text-red-500">{errors.projectType}</p>
                                )}
                              </div>
                            </div>
                            <div className="mt-8">
            ...
            >
              Project Name
                ...
                <div className="mt-2">
                  ...
                  />
                  {errors.projectName && (
                    <p className="mt-2 text-red-500">{errors.projectName}</p>
                  )}
              ...
              <div className="mt-8">
                ...
                <div className="mt-2">
                  ...
                  {errors.projectDescription && (
                    <p className="mt-2 text-red-500">{errors.projectDescription}</p>
                  )}
                </div>
              </div>
              <div className="mt-8">
                ...
                <div className="mt-2">
                  ...
                  {errors.projectStatus && (
                    <p className="mt-2 text-red-500">{errors.projectStatus}</p>
                  )}
                </div>
              </div>
              <div className="mt-8">
              ...
              <div className="flex flex-wrap mt-8">
                <div className="pr-4 sm:w-1/2">
                  ...
                  <div className="mt-4">
                    ...
                    />
                    {errors.createdDate && (
                      <p className="mt-2 text-red-500">{errors.createdDate}</p>
                    )}
                  </div>
                </div>
                <div className="mt-4 sm:w-1/2 sm:mt-0">
                  ...
                  <div className="mt-4">
                    ...
                    />
                    {errors.endDate && (
                      <p className="mt-2 text-red-500">{errors.endDate}</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="mt-16">
                ...
                >
                  ...
                  Assign Project Manager
                    ...
                    {/* ///////////// */}
                    <div className="flex justify-center mt-16 mb-5 gap-x-6">
                      <button
                        type="button"
                        onClick={saveProject}
