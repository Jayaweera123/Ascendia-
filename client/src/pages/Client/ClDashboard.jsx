...
import TopNavigationClient from "../../components/Client/TopNavigationClient"; // Adjust the path based on your project structure
...
const ClDashboard = () => {
  ...
  return (
      ...
      <div className="relative h-screen">
        ...
        <button className="overflow-hidden rounded-3xl">
          <div className="grid grid-cols-[100px,1fr] pl-10 gap-x-0">
            ...
            <div className="p-4 bg-[#001b5e] text-white w-[100px] items-centered pl-6 rounded-l-3xl">
              <div><MdOutlineRateReview size={50} /></div>
            </div>

            {/* Column 2 */}
            <div className="p-4 bg-white w-[300px] opacity-80">
            <h2 className="text-3xl pl-5 text-left leading-relaxed font-bold text-[#001b5e]">Add Review</h2>
            </div>
          </div>
        </button>
        <br></br>
        ...
        <button className="overflow-hidden rounded-3xl">
          <div className="grid grid-cols-[100px,1fr] pl-10 gap-x-0">
            {/*Column 1 */}
            <div className="p-4 bg-[#001b5e] text-white w-[100px] items-centered pl-6 rounded-l-3xl">
              <div><GiProgression size={50} /></div>
            </div>

            {/* Column 2 */}
            <div className="p-4 bg-white w-[300px] opacity-80">
            <h2 className="text-3xl pl-5 text-left leading-relaxed font-bold text-[#001b5e]">View Progress</h2>
            </div>
          </div>
        </button>
        <br></br>
        ...
        <button className="overflow-hidden rounded-3xl">
          <div className="grid grid-cols-[100px,1fr] pl-10 gap-x-0">
            {/*Column 1 */}
            <div className="p-4 bg-[#001b5e] text-white w-[100px] items-centered pl-6 rounded-l-3xl">
              <div><FaTasks size={50} /></div>
            </div>

            {/* Column 2 */}
            <div className="p-4 bg-white w-[300px] opacity-80">
            <h2 className="text-3xl pl-5 text-left leading-relaxed font-bold text-[#001b5e]">View Timeline</h2>
            </div>
          </div>
        </button>
      </div>
    ...
    <div className="text-center profile">
      ...
      <h6 className="text-sm">Client</h6>
      ...
      <div className="flex items-center justify-center py-1 border-b-2 border-white"></div>
        <div className="flex items-center gap-3 pt-2 pl-5 justify-items-start">
          ...
          <h6 className="text-xs">CL 10457</h6>
        </div>
        <div className="flex items-center gap-2 pt-2 pl-5 justify-items-start">
          <div><FaDiagramProject size={19} /></div>
          <h6 className="text-xs">Project</h6>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center py-1 border-b-2 border-white"></div>
        ...
        <div className="flex items-center gap-2 pt-2 pb-5 pl-5 justify-items-start">
          ...
          <h6 className="text-xs">jayaweerabrd@gmail.com</h6>
        </div>
      </div>
