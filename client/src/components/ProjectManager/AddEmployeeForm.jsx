...
function AddEmployeeForm({ projectId }) {
  ...
  /*function handlePopup() {
    ...
    const selectedEmployeeNames = selectedEmployees.map((userId) => {
      ...
      <table class="w-full">
      <tbody>
  <tr class="flex  py-1 space-x-2">
    <td class="w-8 h-8 flex-shrink-0 text-left">
      <img
    ...
    <td class="flex-1 min-w-0 text-left">
    ...
    <td class="flex-1 text-left w-1/5">
            ...
            <form className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-3">
                    ...
                    >
                      ...
                      <option className="option-style" value="Supervisor">
                        Supervisor
                      </option>
                      <option className="option-style" value="Store Keeper">
                        Store Keeper
                      </option>
                    </select>
                  </div>
              ...
              <div>
                ...
                <div className="mt-3">
                  <div>
                    <div>
                      <div className="p-0 bg-white rounded-lg border  sm:pl-5 sm:py-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="flow-root">
                          ...
                          >
                            {filteredEmployees.length === 0 ? (
                              <li className="py-1 sm:py-2 text-center text-gray-500">
