    ...
    <nav className="relative border-gray-200 dark:bg-gray-900">
      ...
      <div className="relative flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
        ...
        <div className="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
          {/* Notification Icon */}
          {/* <button type="button" className="flex text-sm bg-white rounded-full md:me-4 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
