...
const TopNavigation = () => {
  return (
    <nav className="relative border-gray-200 dark:bg-gray-900">
      <div className="absolute inset-0 bg-gradient-to-l from-yellow-300 to-yellow-900" aria-hidden="true"></div>
