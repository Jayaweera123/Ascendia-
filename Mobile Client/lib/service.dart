...
class Service {
  ...
  Future<void> saveComment(int taskId, String commentText, int userID) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            'http://localhost:8080/sengineer/comment/sengineer/comment/createComment'),
        headers: {
  ...
  Future<void> updateComment(
      int commentId, String CommentText, int userID, int taskId) async {
    try {
      final token = await getToken();
      if (token == null) {
        throw Exception('Token not found');
  ...
  Future<void> saveTask(String taskName, String description, DateTime startDate,
      DateTime endDate, int projectId) async {
    final Map<String, dynamic> data = {
      'taskName': taskName,
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            'http://localhost:8080/sengineer/task/add'), //http://localhost:8080/sengineer/task/add
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
  ...
  Future<void> updateTask(int taskId, String taskName, String description,
    ...
    try {
      ...
      final response = await http.put(
        Uri.parse(
            'http://localhost:8080/sengineer/$taskId/edit'), //http://10.0.2.2:8080/api/task//{taskId}/edit
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        }, // http://10.0.2.2:8080/api/v2/comment/$commentId
        body: json.encode(data),
      );
  ...
  Future<void> deleteTask(int taskId) async {
    try {
      ...
      print("object  21");
      final response = await http.delete(
        Uri.parse('http://localhost:8080/sengineer/task/$taskId'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
  ...
  Future<void> CreateJobs(String jobName, String description,
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            'http://localhost:8080/senginner/createJob'), //http://10.0.2.2:8080/api/job/createJob
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        }, //http://10.0.2.2:8080/api/task/all
        body: json.encode(data),
      );
      print("object 05");
      if (response.statusCode == 201) {
  ...
  Future<void> updateJob(int jobId, String jobName, String description,
      DateTime startDate, DateTime endDate, int taskId) async {
    final Map<String, dynamic> data = {
      'jobName': jobName,
      'description': description,
  ...
  Future<void> saveCommentJob(
      int jobId, int userID, String commentJobText) async {
    final Map<String, dynamic> data = {
      'job': {
        'jobId': jobId,
      },
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            'http://localhost:8080/sengineer/commentJob/sengineer/comment/createJobComment'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
  ...
  Future<void> updateCommentJob(
      int commentJobId, String CommentJobText, int userID, int jobId) async {
    try {
      final token = await getToken();
      if (token == null) {
        throw Exception('Token not found');
  ...
  Future<void> deleteCommentJob(int commentjobId) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse(
            'http://localhost:8080/sengineer/commentJob/delete/$commentjobId'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
