...
class UpdatingJobForm extends StatefulWidget {
  ...
  @override
  State<UpdatingJobForm> createState() => _ProjectSiteState();
}
...
class _ProjectSiteState extends State<UpdatingJobForm> {
    late TextEditingController jobFormDescription;
  late TextEditingController jobFormName;
  ...
  void initState() {
    super.initState();
    fetchTasks();
    jobFormName = TextEditingController(text: widget.jobName);
    jobFormDescription = TextEditingController(text: widget.description);
  ...
  late String taskName; // Define taskName here
  List<Task> tasks = [];
  Task? selectedTask ;
  ...
  void fetchTasks() async {
    try {
      ...
      setState(() {
        tasks = fetchedTasks;
        selectedTask = tasks.firstWhere((task) => task.taskName == widget.task.taskName);
      });
    } catch (e) {
...
print("object 04");
  ...
  if (userInputTask.isNotEmpty) {
    setState(() {
      ...
      editeJob(widget.jobId,jobFormName.text,jobFormDescription.text,startDate,endDate,selectedTask!.taskId);
      print("object 02");
      print(startDate);
      print(endDate);
...
//int jobId, String jobName, String description,DateTime startDate,DateTime endDate,int taskId


 void editeJob(int jobId,String jobName,String description,DateTime startDate,DateTime endDate,int taskId) async {
            ...
            TextButton(
              onPressed: () async {
                print("object edite 01");
                  ...
                  await service.updateJob(jobId, jobName, description,startDate,endDate,taskId);
