...
Future<List<Task>> getAllTasks() async {
  ...
  final response = await http.get(
    Uri.parse(
        "http://localhost:8080/sengineer/all"), //http://localhost:8080/senginner/createJob
    headers: {
  ...
  void fetchTasks() async {
    try {
      ...
      setState(() {
        tasks = fetchedTasks;
        selectedTask =
            tasks.firstWhere((task) => task.taskName == widget.task.taskName);
      });
    } catch (e) {
...
//int jobId, String jobName, String description,DateTime startDate,DateTime endDate,int taskId
  ...
  void editeJob(int jobId, String jobName, String description,
              ...
              TextButton(
                onPressed: () async {
                  ...
                  await service.updateJob(
                      jobId, jobName, description, startDate, endDate, taskId);
