...
Future<List<Task>> getAllScheduledTasks(int projectId) async {
  ...
  final response = await http.get(
    ...
    Uri.parse(
        "http://localhost:8080/supervisor/api/task/$projectId/Scheduled"), //http://localhost:8080/api/task/api/task/$projectId/scheduled
    headers: {
                                    ...
                                    showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          content: const Text(
                                              'Are you sure this task is ready to process ?'),
                                          actions: <Widget>[
                                            TextButton(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title:
                                                          const Text('Success'),
                                                      content: const Text(
                                                          'Task is moved to In-Progress task list successfully!'),
                                                      actions: <Widget>[
                                                        TextButton(
                                                          child:
                                                              const Text('OK'),
