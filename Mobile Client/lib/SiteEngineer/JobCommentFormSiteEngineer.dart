...
class JobCommentSite extends StatefulWidget {
  ...
  JobCommentSite({Key? key, required this.jobId, required this.jobName})
      : super(key: key);
...
Future<List<CommentJob>> getCommentByJob(int jobId) async {
  print("enter to the getCommentByJob");
  print("jobId: $jobId *************");
  ...
  print(token);
  print("project getCommentByJob out");

  final response = await http.get(
    Uri.parse("http://localhost:8080/sengineer/commentJob/job/$jobId"),
    headers: {
  ...
  if (response.statusCode == 200) {
    ...
    return jsonData
        .map((commentJobData) => CommentJob.fromJson(commentJobData))
        .toList();
  } else {
...
class _ProjectSiteState extends State<JobCommentSite> {
                                              ...
                                              child: FutureBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  if (snapshot
                                                    ...
                                                    print("object10   new");
                                                    final List<CommentJob>
                                                        commentJobs =
                                                        snapshot.data!;
                                                    return Column(
                                                      children: commentJobs
                                                          .map((commentJob) {
                                                        print("card on");
                                                        print(commentJob
                                                            .commentJobText);
                                                        print("card on");
                                                        // print(commentJob.commentedJobUser.firstName);
                                                        print(commentJob
                                                            .commentJobDate);
                                                        print(commentJob
                                                            .commentedJobUser);
                                                  ...
                                                  setState(() {
                                                    ...
                                                    print(
                                                        controllertaskscomment1
                                                            .text);
                                                    print(
                                                        "enter before to the save Comment Job ");
                                                    service.saveCommentJob(
                                                        widget.jobId,
                                                        1,
                                                        controllertaskscomment1
                                                            .text);
  ...
  void _editData(
      int commentJobId, String jobName, int userId, int jobId) async {
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              TextButton(
                onPressed: () async {
                  print(commentJobId);
                  await service.updateCommentJob(
                      commentJobId, updatedComment, userId, jobId);
