...
Future<List<Task>> getAllInProgressTasks(int projectId) async {
  ...
  final response = await http.get(
    ...
    Uri.parse(
        "http://localhost:8080/supervisor/api/task/$projectId/inProgress"), //http://localhost:8080/api/task/api/task/$projectId/scheduled
    headers: {
